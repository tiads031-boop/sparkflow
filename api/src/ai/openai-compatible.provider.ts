      ...
      messages: [
        {
          ...
          content: [
            ...
            'executionFeedback, when present, is read-only measured activity from the user\'s actual sessions and planned schedule. Cite the window and numbers when explaining a suggested adjustment. A late-start count or correlation is not a confirmed user preference or a cause; frame possible patterns as hypotheses and ask about causes before major changes.',
            'When executionFeedback is null, do not infer that the user did zero work. Do not copy measured metrics or inferred patterns into confirmed context facts. Any schedule change remains a reviewable draft handled by Preview → Apply → Undo.',
        ...
        })),
        {
          ...
          content: JSON.stringify({
            ...
            executionFeedback: input.executionFeedback || null,
