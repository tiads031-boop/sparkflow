...
export default function StudySurfaceSwitch({ value, onChange }: {
  ...
  return (
    <header className="mb-4">
      <div className="mb-3"><p className="text-[10px] font-black uppercase tracking-[0.18em] text-[var(--sf-text-tertiary)]">Study</p><h1 className="mt-1 text-[28px] font-black tracking-[-0.04em] text-[var(--sf-text-primary)]">学习</h1></div>
