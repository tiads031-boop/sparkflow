...
> 每个改进方案独立维护，完成后移入 `../archive/`。最后更新：2026-09-13。
...
| 文件名 | Phase | 简述 | 状态 |
|---|---|---|---|
| [p0-phase12-execution.md](p0-phase12-execution.md) | P0/12 | 生产基线、CI、四步导入与幂等发布的执行总计划 | 🚧 M2.3 验收修复已实现，待 PR/CI/Preview |
...
| [phase12-course-import-experience.md](phase12-course-import-experience.md) | 12 | 课程页入口收敛、教务导入向导、作息编辑与部署验收 | 🚧 M2.3 验收修复已实现，待 PR/CI/Preview |
...
| 文件名 | Phase | 简述 |
|---|---|---|
| [../archive/phase08-capacitor-setup.md](../archive/phase08-capacitor-setup.md) | 08 | Capacitor Android APK 打包 + 联调 |
| [../archive/phase08-google-calendar-sync.md](../archive/phase08-google-calendar-sync.md) | 08 | Google Calendar 双向同步架构 |
...
1. **新建方案**：在 `docs/plans/` 下创建 `phaseXX-description.md`，更新本索引
2. **方案完成**：将其移至 `docs/archive/`，更新本索引
3. **命名**：用 `phaseXX-description.md` 格式（如 `phase09-course-module.md`），不用无编号 slug
4. **归档文件只读**：历史方案仅作参考，不再修改
