...
- [ ] **M5 / AI 规划与调整 2.0**：把固定“AI 帮我安排”改为对话式助手；支持文字 + 语音输入、转写预览、必要追问、理解卡、临时想法/任务、Preview → Apply → Undo。
- [ ] **M6 / 学习目标 AI**：Study 与 Course 完全解耦；学习围绕目标、截止、当前水平、每周时间进行 AI 访谈与拆解；执行项继续写共享 Task。
